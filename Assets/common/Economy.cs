...
static public class Economy
{
    ...
    static public Dictionary<string, CommodityInfo> getIndustryCommodityInfo()
    {
        return commodityInfo.Where(c => c.Value.category == "minerals" || c.Value.category == "chemicals" ||
                                   c.Value.category == "medical" || c.Value.category == "products" ||
                                   c.Value.category == "weapons" || c.Value.category == "narcotic")
