...
static public class Faction
{
    ...
    static public string getFactionName(Faction.FactionID id, bool flipped = false)
    {
        switch (id)
        {
            ...
            case FactionID.heretic: return flipped ? "Ingenium" : "Radical Movement";
            default: return "";
        }
    }
    ...
    {
        if (id == FactionID.noble1) return !hasFlipped ? "Furia is an old noble family, older than the colonies on the sector, older even than the Imperium itself. Or that's what they tell you. They are warriors and weapon-makers and masters of clones. Sporting heavily militarized autonome planets, they are always under the scrutiny from the Capital, as well as the Imperial enforcers Church and House Tarquinia."
                                                        : "Furia is an old noble family, older than the Imperium. Or that's what they tell you. They are warriors and weapon-makers and masters of clones. As the heirs to Old Furia, they are working to secede from the Empire and for a new nation on the sector. Looking for allies, their support is entrenched in the sector backwaters.";
