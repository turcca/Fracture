...
//        if (writingFile)
//        {
//            writeTemplate("Events.cs");
//        }		// write eventData to events.js in the right place
...
//        ADD("// Events.cs compiled: " + theDate + " " + theTime);
...
//        //			ADD(" \n ");
//        ADD("Dictionary<string, EventClass> event = new Dictionary<string, EventClass>();");
//        //ADD("var trigger: Dictionary.<String, eventClass> = new Dictionary.<String, eventClass>();");
//        ADD("Dictionary<string, AdviceClass> advice = new Dictionary<string, AdviceClass>();");
//        ADD(" \n ");
//        // advice class
//        ADD("class adviceClass {");
//        ADD("   string opinion = \"NOT DEFINED\";");
//        ADD("   int recommend = -1;");
//        ADD("}");
//        ADD(" \n ");

//        ADD("int eventCount = 0;");
//        ADD("int triggerCount = 0;");
//        ADD("string name = \"\"; // current event name");
//        ADD("Dictionary<string, float> filterWeights = new Dictionary<string, float>();");
...
//        ADD("   string name = \"\"; // Unique id, name of the event");
//        ADD("   bool available = false; // is event available for spawning");
//        ADD("   Fraq frequency = Freq.Default;");
//        ADD("   Status situation = Status.Default; // event situation (ambient sounds: mood and tone)");
//        ADD("   Noise ambient = Noise.DefaultBridge; // event ambient location (ambient sounds: location and background noise)");
//        ADD("   List<string> filters = new List<string>();");
//        ADD("   string triggerType = null; // if != null, trigger Event. List trigger type: inLocation, atLocation, object");
//        ADD("   GameObject triggerObject = null; // triggerType may specify a particular object");
...
//    void ADDcharInt(int unicode)
//    {
//        string a = System.Char.ConvertFromUtf32(unicode);
...
//    string returnCharByInt(int unicode)
//    {	// add char by unicode decimal value
//        string a = System.Char.ConvertFromUtf32(unicode);
...
//        {
//            char c = charInput(charPos);
//            emptyloop = true;
//            // Look for a new event or a tag
//            getTag(c);
//            // length check
//            if (charPos >= templateLength)
//            {
//                if (debugging)
//                {
//                    Debug.Log("Template reached its length (" + charPos + " / " + templateLength + ")");
//                }
//                break;
//            }
//            // charPos +1 check
...
//                if (charPos + 1 < templateLength)
//                {
//                    charPos += 1;
//                    if (debugging) Debug.Log("moving to " + charInput(charPos));
//                }
//                else
//                {
//                    if (debugging) Debug.Log("End read, templated length met"); break;
//                }
//            }
//        }
//    }
...
//        // record Event.name
//        ADD("// EVENT " + eventCount);
//        eventName = recordString(false);
//        ADD("eventCount++;");
//        ADD("if (event.ContainsKey(" + eventName + ")) { Debug.LogError(\"ERROR: event " + eventName + " already excists.\"); }");
//        // Create event object
//        ADD("event.Add(name, new EventBase(name));");
//    }
...
//    void writeTemplate(string file)
//{
//    if (File.Exists(file))
//    {
...
//    string recordString(bool newLine)
//{
//    string record;
//    string stringStart = charPos;
